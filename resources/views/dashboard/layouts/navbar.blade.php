					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{asset($currentUser->profile_photo_path??'images/1.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{asset($currentUser->profile_photo_path??'images/1.png')}}" class=""></div>
											<div class="ml-3 my-auto">
												<h6>{{$currentUser->firstname}} {{$currentUser->lastname}}</h6><span>Premium Member</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{ route('settings') }}"><i class="bx bx-cog"></i> Edit Profile</a>
									<a class="dropdown-item" href="{{ route('settings') }}"><i class="bx bx-slider-alt"></i> Account Settings</a>
